...
class ModelDataHandler {
  ...
  /// labels files are successfully loaded from the app's main bundle. Default `threadCount` is 1.
    init?(modelFilePath: String, labelsFileURL: URL, threadCount: Int = 1) {
    ...
    do {
      ...
      interpreter = try Interpreter(modelPath: modelFilePath, options: options)
    ...
    loadLabels(labelsURL: labelsFileURL)
  }
